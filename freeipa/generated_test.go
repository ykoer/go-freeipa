...
func Test_ServiceFindResultUnmarshal_withMinimumResponse(t *testing.T) {
	var res serviceFindResponse
	decoder := json.NewDecoder(strings.NewReader(minimumIpaResponse))
	if e := decoder.Decode(&res); e != nil {
		t.Error(e)
	}
}
